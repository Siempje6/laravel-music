...
<body>
    ...
    <header>
        <div class="nav-wrap container" style="display:flex;align-items:center;justify-content:space-between;">
            ...
            <div class="nav-actions" style="display:flex;align-items:center;gap:12px;">
                <form action="{{ route('search') }}" method="GET" class="search">
                    <input type="search" name="q" placeholder="Zoeken..." value="{{ request('q') }}" />
                </form>
    ...
    <footer>
        <p>&copy; {{ date('Y') }} Music Library. All rights reserved.</p>
    </footer>
